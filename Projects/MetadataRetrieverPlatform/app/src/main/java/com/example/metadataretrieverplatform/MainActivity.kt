...
//        extractorTest()
        ...
        retrieverTest("Bulk") { activity, mediaPath, iterations ->
            RetrieverTest(activity, mediaPath, iterations).startMetadataRetrievalTestBulk()
        }
...
//        retrieverTestToni()
    ...
    private fun retrieverTestToni() {
        RetrieverTestToni.startMetadataRetrievalTest(this)
    }
}